...
_setting('qwen_tts_top_k', 'Qwen sampling top K', 'Speech output', 40, 1, 1000)
_setting('qwen_tts_repetition_penalty', 'Qwen repetition penalty', 'Speech output', 1.05, .1, 2.0)
_setting('qwen_tts_seed', 'Qwen sampling seed', 'Speech output', 42, -2147483648, 2147483647)
