...
final class OpenClawClient {
    ...
    private static JSONArray nodeCommands() {
        return new JSONArray()
                ...
                .put("android.capabilities")
                .put("android.permissions.request")
                .put("android.settings.app")
                .put("android.settings.notificationAccess")
                .put("android.settings.accessibility")
                .put("contacts.search")
                .put("contacts.add")
                .put("calendar.events")
                .put("calendar.add")
                ...
                .put("notifications.act")
                .put("media.search")
                .put("android.intent.open")
                .put("android.intent.composeSms")
                .put("android.intent.composeEmail")
                .put("android.intent.dial")
                .put("android.call.place")
                .put("android.intent.setAlarm")
                .put("android.intent.setTimer")
